...
import { File, FileDeleteAllResponse, FileDeleteResponse, FileUploadParams, Files, Fileslist } from "./files.js";
import { SessionsCursor, type SessionsCursorParams } from "../../pagination.js";
export declare class Sessions extends APIResource {
     ...
     */
    list(query?: SessionListParams, options?: Core.RequestOptions): Core.PagePromise<SessionslistSessionsSessionsCursor, Sessionslist.Session>;
    list(options?: Core.RequestOptions): Core.PagePromise<SessionslistSessionsSessionsCursor, Sessionslist.Session>;
    /**
     ...
     */
    release(id: string, body?: SessionReleaseParams | null | undefined, options?: Core.RequestOptions): Core.APIPromise<SessionReleaseResponse>;
    /**
     * Releases all active sessions for the current organization.
     */
    releaseAll(body?: SessionReleaseAllParams | null | undefined, options?: Core.RequestOptions): Core.APIPromise<SessionReleaseAllResponse>;
}
export declare class SessionslistSessionsSessionsCursor extends SessionsCursor<Sessionslist.Session> {
}
/**
...
export declare namespace SessionLiveDetailsResponse {
    interface Page {
        id: string;
        favicon: string | null;
        sessionViewerFullscreenUrl: string;
...
export declare namespace Sessions {
    export { type Session as Session, type SessionContext as SessionContext, type Sessionslist as Sessionslist, type SessionEventsResponse as SessionEventsResponse, type SessionLiveDetailsResponse as SessionLiveDetailsResponse, type SessionReleaseResponse as SessionReleaseResponse, type SessionReleaseAllResponse as SessionReleaseAllResponse, SessionslistSessionsSessionsCursor as SessionslistSessionsSessionsCursor, type SessionCreateParams as SessionCreateParams, type SessionListParams as SessionListParams, type SessionReleaseParams as SessionReleaseParams, type SessionReleaseAllParams as SessionReleaseAllParams, };
    export { Files as Files, type File as File, type Fileslist as Fileslist, type FileDeleteResponse as FileDeleteResponse, type FileDeleteAllResponse as FileDeleteAllResponse, type FileUploadParams as FileUploadParams, };
}
